...
export declare class Braze extends Common {
    static getInstance(): Braze;
    appboy: Appboy;
     ...
     * @param {function(error, result)} callback - A callback that receives the  call result.
     */
    setGender(
     ...
     */
    logCustomEvent(eventName: string, eventProperties?: object): void;
     ...
     * @param {function(error, result)} callback - A callback that receives the  call result.
     */
    unsetCustomUserAttribute(key: string, callback?: Callback): void;
